...
const Attendance = () => {
    ...
    const toggleAttendance = (studentId, attendanceType) => {
        setAttendance(prev => ({
            ...prev,
            [studentId]: {
    ...
    const addStudent = (student) => {
        const nameExists = students.some(existingStudent => 
            existingStudent.name.toLowerCase() === student.name.toLowerCase() && existingStudent.section === student.section
        );
        ...
        setStudents([...students, student]); // Add the entire student object
    };
    ...
    return (
        <div className='attendance-container'>
            <h1>Attendance</h1>
            <AddStudentForm onAddStudent={addStudent} students={students} />
